<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><img style="width: 4rem" src="../images/marketMini.png" alt=""></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img style="width: 10rem" src="../images/market.png" alt=""></span>
  </a>
  ...
  <nav class="navbar navbar-static-top" style="position: relative;">
    ...
    <div style="font-size: 25px; margin-left: 2rem; color: white; position: absolute; top: 6px; left: 50px">Admin Panel</div>
